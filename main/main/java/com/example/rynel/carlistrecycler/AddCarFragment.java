...
public class AddCarFragment extends Fragment {
    ...
    EditText carModel, carType, carYear;
    Button addCar;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        carModel = (EditText) view.findViewById( R.id.etvCarFragModel );
        carType = (EditText) view.findViewById( R.id.etvCarFragType );
        carYear = (EditText) view.findViewById( R.id.etvCarFragYear );
        addCar = (Button) view.findViewById( R.id.btnAddCar );
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void getCar( String model, String type, String year );
    }
}